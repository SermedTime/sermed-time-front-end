...
import { IWorkingDay } from '@/hooks/services/Parameters/Management/useWorkingDay'
...
export function WorkingDayTable({ data, onEdit, onRefetch }: Props) {
    ...
    try {
      ...
      if (data) {
        ...
        addToast({
          type: 'success',
          title: 'Sucesso!',
          description: 'Jornada de trabalho ativada com sucesso!'
        })
      }
    } catch {
      handleApiRejection()
    ...
    try {
      ...
      if (data) {
        ...
        addToast({
          type: 'success',
          title: 'Sucesso!',
          description: 'Jornada de trabalho inativada com sucesso!'
        })
      }
    } catch {
      handleApiRejection()
  ...
  return (
    <Tr>
      ...
      <Td>
        <Paragraph size="sm">{data.workingDayName}</Paragraph>
      </Td>
