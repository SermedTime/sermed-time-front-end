...
export function EditHoliday({ uuid, onClose }: Props) {
  ...
  const [initialValues, setInitialValues] =
    useState<IHolidayRegisterForm | null>(null)
    ...
    try {
      ...
      if (data) {
        addToast({
          type: 'success',
          title: 'Sucesso',
          description: 'O cadastro do feriado foi editado.'
        })
      ...
      <Row className="align-items-center mb-4">
        <Col xs="auto">
          <div className="d-flex align-items-center gap-2">
            ...
            <Subtitle size="sm">Editar Feriado</Subtitle>
          </div>
        </Col>
