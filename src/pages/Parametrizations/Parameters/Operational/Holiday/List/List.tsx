...
import { useHolidays } from '@/hooks/services/Parameters/useHolidays'
...
import { HolidayFilterForm } from '../components/FilterForm'
import {
  IHolidayFilterForm,
  initialFilterValues
...
export function ListHoliday() {
  ...
  const { result, params, refetch, setParams } = useHolidays()
  ...
  function handleOnFilter(data: IHolidayFilterForm) {
    if (params) {
      const { records, holidayType, state, initialDate, finalDate } = data
                ...
                <Col>
                  <Table>
                    <Tr>
                      ...
                      >
                        <Heading size="xs">Data do Feriado</Heading>
                      </Th>
